export class SavedRecipesPage extends HTMLElement {
  constructor() {
    super();
  ...
  async loadSavedRecipes() {
    try {
      ...
      this.innerHTML = this.renderError('Хадгалсан жор ачааллахад алдаа гарлаа');
    }
  }
...
customElements.define('saved-recipes-page', SavedRecipesPage);
